...
class GenerateResultsCompta(Wizard):
    ...
    def transition_generate_compta_examen_validation(self):
        ...
        Commissions = Commissions.search([('origin.invoice.reference', 'in', listes_cotations, 'account.invoice')])
        ...
        for commission in Commissions:
            ...
            if Synth_Commissions.search([('number_invoice','=', commission.origin.invoice.number)]) == []:
